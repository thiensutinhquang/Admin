...
const CACHE_NAME = 'mstq-sukien-pwa-v4'; // Đã tăng phiên bản
...
const urlsToCache = [
  ...
  // Apple Touch Icons (đảm bảo các tệp này tồn tại trong thư mục /icons/ nếu bạn dùng thư mục đó)
  // Nếu bạn đặt chúng ở thư mục gốc, hãy sửa đường dẫn.
  './icons/icon-180.png',
  './icons/icon-152.png',
  './icons/icon-120.png',
  ...
  './images/widget-screenshot-calendar.png', // Ảnh chụp màn hình widget (nếu triển khai widget)
  ...
  // Tệp Widget HTML (nếu triển khai widget)
